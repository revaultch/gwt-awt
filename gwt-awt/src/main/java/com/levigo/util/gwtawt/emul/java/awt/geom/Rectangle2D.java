...
public abstract class Rectangle2D extends RectangularShape {
  ...
  /**
   * The <code>Float</code> class defines a rectangle specified in float coordinates.
   * 
   * @since 1.2
   */
  public static class Float extends Rectangle2D implements Serializable {
    ...
    /**
     * Constructs a new <code>Rectangle2D</code>, initialized to location (0.0,&nbsp;0.0) and size
     * (0.0,&nbsp;0.0).
     * 
     * @since 1.2
     */
    ...
    /**
     * Sets the location and size of this <code>Rectangle2D</code> to the specified
  ...
  /**
   * The <code>Double</code> class defines a rectangle specified in double coordinates.
   * 
   * @since 1.2
   */
  public static class Double extends Rectangle2D implements Serializable {
    ...
    /**
     * Constructs a new <code>Rectangle2D</code>, initialized to location (0,&nbsp;0) and size
     * (0,&nbsp;0).
     * 
     * @since 1.2
     */
...
//  public static class Double_CustomFieldSerializer extends CustomFieldSerializer<Double> {
...
//  }
   ...
   * <code>Rectangle2D</code>. This method computes a binary OR of the appropriate mask values
   * indicating, for each side of this <code>Rectangle2D</code>, whether or not the specified
  ...
  /**
   * Returns a new <code>Rectangle2D</code> object representing the intersection of this
   * <code>Rectangle2D</code> with the specified <code>Rectangle2D</code>.
   * 
  ...
  /**
   * Returns a new <code>Rectangle2D</code> object representing the union of this
   * <code>Rectangle2D</code> with the specified <code>Rectangle2D</code>.
   * 
  ...
  /**
   * Adds a point, specified by the double precision arguments <code>newx</code> and
   * <code>newy</code>, to this <code>Rectangle2D</code>. The resulting <code>Rectangle2D</code> is
   * the smallest <code>Rectangle2D</code> that contains both the original <code>Rectangle2D</code>
  ...
  /**
   * Adds the <code>Point2D</code> object <code>pt</code> to this <code>Rectangle2D</code>. The
   * resulting <code>Rectangle2D</code> is the smallest <code>Rectangle2D</code> that contains both
   * the original <code>Rectangle2D</code> and the specified <code>Point2D</code>.
   * <p>
   * After adding a point, a call to <code>contains</code> with the added point as an argument does
   * not necessarily return <code>true</code>. The <code>contains</code> method does not return
   * <code>true</code> for points on the right or bottom edges of a rectangle. Therefore, if the
  ...
  /**
   * Adds a <code>Rectangle2D</code> object to this <code>Rectangle2D</code>. The resulting
   * <code>Rectangle2D</code> is the union of the two <code>Rectangle2D</code> objects.
   * 
  ...
  /**
   * Returns an iteration object that defines the boundary of this <code>Rectangle2D</code>. The
   ...
   * <code>Rectangle2D</code>. The specified <code>Object</code> is equal to this
   * <code>Rectangle2D</code> if it is an instance of <code>Rectangle2D</code> and if its location
   * and size are the same as this <code>Rectangle2D</code>.
   * 
