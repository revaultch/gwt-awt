...
//      return getFontName(Locale.getDefault());
      return getName(); //TODO das wird benötigt ist name wirklichdas passende?
    }
...
//            strStyle + ",size=" + size + "]"; //TODO soon quatsch
        return getClass().getName() + "["/*family=" + getFamily() + ",*/+"name=" + name + ",style=" +
        strStyle + ",size=" + size + "]";
    } // toString()
...
//             java.io.IOException
//    {
//        if (false /*&& values != null*/) {//TODO das ist nicht sinnvoll
////          synchronized(values) {
////            // transient
...
//
//        if (fRequestedAttributes != null) { // TODO
